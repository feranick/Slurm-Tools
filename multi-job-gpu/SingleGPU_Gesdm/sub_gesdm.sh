#!/bin/bash
#============================================================
# SLURM submit script for DataML_DAE jobs on "GridEdgeDM" (gesdm)
# 8 CPUs, ~22 GB RAM, 1x RTX 3050 (Ampere), GPU shared via MPS.
#
...
#   Concurrency: 8 CPUs / 2 = ~4 jobs at once (CPU-limited)
#   --gres=mps:25      -> 100/25 = 4 GPU slices; GPU is not the bottleneck
#============================================================
